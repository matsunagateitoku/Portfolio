...
- [News Website,version1.0](https://matsunagateitoku.github.io/news/) First draft
...
I build analyst-facing tools at the intersection of **translation technology**, **NLP**, and **AI integration**. My work focuses on bridging machine learning capabilities with real analyst workflows — from federated glossary search to multi-model evaluation pipelines.

Previously a visiting professor in East Asian Studies. Fluent in the gap between what language models do and what translators actually need.
...
**NLP / ML:** spaCy · NLTK · FastText · BM25 · SPLADE · BGE-M3 · Hugging Face  
**Data:** Pandas · NumPy · Scikit-learn  
**Cloud:** AWS Bedrock · SageMaker · Comprehend · Lambda  
**Languages:** English · Chinese (Mandarin) · Japanese

---

## ⬡ Featured Project — LEXI

> AI-powered translation glossary with federated multi-source search and contextual recommendations.

| Resource | Link |
|---|---|
| 📄 Project Plan | [LEXI Plan (PDF)](https://matsunagateitoku.github.io/Portfolio/websites/lexi.pdf) |
| 🚀 Live Demo | [lexi4.html](https://matsunagateitoku.github.io/Portfolio/websites/lexi4.html) |
| 🔬 Lo-Fi Mockups | [View](https://matsunagateitoku.github.io/Portfolio/websites/lexi_wire.html) |
| 🎨 Mockups | [View](https://matsunagateitoku.github.io/Portfolio/websites/lexi_mockups.html) |
| 📐 Wireframes | [View](https://matsunagateitoku.github.io/Portfolio/websites/lexi-wireframes.html) |
| 📋 UX Research | [View](https://matsunagateitoku.github.io/Portfolio/websites/UX_plan.txt) |

---

## 🗣️ NLP Projects

| Project | Status | Notebook |
|---|---|---|
| Basic NLP Techniques | ✅ Live | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/matsunagateitoku/Portfolio/blob/main/notebooks/VISTA%20Vision.ipynb) |
| NLP Text Processing Pipeline | ✅ Live | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/matsunagateitoku/Portfolio/blob/main/notebooks/Text%20preprocessing%20pipeline%20%281%29.ipynb) |
| NLP on Chinese Text | ✅ Live | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/matsunagateitoku/Portfolio/blob/main/notebooks/Chinese%20Vista%20Vision%20for%20export.ipynb) |
| eCornell Notes | ✅ Live | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/matsunagateitoku/Portfolio/blob/main/notebooks/eCornell_new.ipynb) |
| NER Flask Tool | 🔧 Coming soon | — |
| POS Flask Tool | 🔧 Coming soon | — |
| Federated Dictionary Tool | 🔧 Coming soon | — |
| FastText Document Similarity (eCornell) | 🔧 Coming soon | — |
...
| Project | Description | Notebook |
|---|---|---|
| Great Schools API | Comparing local schools using the Great Schools API | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/matsunagateitoku/Portfolio/blob/main/notebooks/GS.ipynb) |
| NBA Over/Unders | Tracking team win totals via the NBA API | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/matsunagateitoku/Portfolio/blob/main/notebooks/NBA_OU.ipynb) |
...
|---|---|---|
| Analyst Workbench v1.0 | Analyst-facing data tool | [→](https://matsunagateitoku.github.io/Portfolio/websites/awb/awb.html) |
| Analyst Workbench v2.0 | Improved iteration | [→](https://matsunagateitoku.github.io/Portfolio/websites/awb/awb2.html) |
| Analyst Workbench v3.0 | Latest version | [→](https://matsunagateitoku.github.io/Portfolio/websites/awb/awb4.html) |
| NLP Toolkit | Deployed NLP Flask application | [→](https://dolphin-app-kjvwi.ondigitalocean.app/) |
| Federated Search Tool | Multi-source search interface | 🔧 Coming soon |

### Content & Creative

| Project | Description | Link |
|---|---|---|
| News Website v1.0 | First iteration of a news aggregation site | [→](https://matsunagateitoku.github.io/news/) |
| News Website v2.0 | Redesigned news site | [→](https://matsunagateitoku.github.io/STDP_News/) |
| News Website v3.0 | AI-driven news | [→](https://matsunagateitoku.github.io/AI_News/) |
| Haiku Website | Classical haiku showcase | [→](https://matsunagateitoku.github.io/Haiku-Website/) |
| Wordcloud | News-driven word cloud visualization | [→](https://matsunagateitoku.github.io/news/wordcloud.html) |
| Family Album | Photo album site | [→](https://matsunagateitoku.github.io/family/) |
...
![Scott's GitHub Stats](https://github-readme-stats.vercel.app/api?username=matsunagateitoku&show_icons=true&theme=dark&hide_border=true&bg_color=0d0f11&title_color=4e9fff&icon_color=00e5b0&text_color=c8d0db)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=matsunagateitoku&layout=compact&theme=dark&hide_border=true&bg_color=0d0f11&title_color=4e9fff&text_color=c8d0db)
...
*AI · NLP · Translation Technology · Language × Code*
